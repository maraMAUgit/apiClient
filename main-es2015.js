...
let AggiornaService = class AggiornaService {
    constructor() {
...
let ListaComponent = class ListaComponent {
    constructor(trhowUser, http, sync) {
    ...
    ngOnInit() {
        this.sync.syncRequest.subscribe((data) => {
            this.reload();
        });
        /*
     ...
     */
        this.APIget();
        this.trhowUser.userDeleted.subscribe(id => {
...
let TestComponent = class TestComponent {
    constructor(myservice, sync) {
        this.myservice = myservice;
        this.sync = sync;
    }
    ngOnInit() {
        this.sync.syncRequest.subscribe((n) => { console.log('la stringa  passaato è:  ' + n); });
        this.myservice.userSelected.subscribe(Utente => {
...
let UsersComponent = class UsersComponent {
    ...
    ngOnInit() {
        ...
        this.getUser.userSelected.subscribe((user) => {
            console.log('io ascolto da users  ', user);
            this.user = user;
        });
    }
    add() {
        const addURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl;
    ...
    delete(id) {
        const delURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/' + id;
...
let View1Component = class View1Component {
    ...
    ngOnInit() {
        this.observer.syncRequest.subscribe((d) => { this.data = d; });
    }
    update() {
...
let View3Component = class View3Component {
    constructor(observer) {
        this.observer = observer;
    }
    ngOnInit() {
